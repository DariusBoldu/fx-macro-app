...
(function () {
  ...
  var QUOTABLE_COMMODITIES = { 'XAU/USD': 1, 'XAG/USD': 0, 'XCU/USD': 0, 'USOIL': 0, 'GER40': 0, 'EU50': 0 };
  ...
  window.PriceAdapter = {
    ...
    formatPrice: function (sym, v) {
      ...
      if (sym === 'XCU/USD') return v.toFixed(4);
      if (sym === 'GER40' || sym === 'EU50') return v.toFixed(1);
