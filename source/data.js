window.FX_DATA = {
  meta: {
    ...
    update: { at: "2026-09-16T18:11:43Z", title: "🇺🇸 USD analysis updated", text: "Fed hiked to 3.75%-4.00%, actual 4% vs 4% forecast. DXY 99.836 +0.22%, month back positive. USD holds +2; USOIL LONG to RANGE as oil fell 3.49%. Dot plot not yet verifiable." },
  },
  ...
  symbols: [
    ...
    },
    {
      ...
      bias: "SHORT",
      conv: "MEDIUM",
      why: "0.57447, -0.21%, week -1.63%, month -2.67%: an RBNZ on hold to October 28 against a Fed that has now hiked to 3.75%-4.00%. The rate-path gap is the whole trade and the delivery widens it.",
      risk: "Held at MEDIUM after yesterday's cut from HIGH, because the reason for that cut stands - NZ consumer confidence rebounded nine points to 89.5 and reversed one of the two pillars under the kiwi short. New Zealand Q2 GDP at 22:45Z tonight is the next event and is a bigger risk to this ticket than the Fed now is; an intact easing path in the unverified dots still reverses it first and fastest."
    },
    {
      sym: "USD/CHF",
      bias: "LONG",
