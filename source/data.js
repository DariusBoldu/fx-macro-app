window.FX_DATA = {
  meta: {
    ...
    update: { at: "2026-09-16T22:57:00Z", title: "🇳🇿 NZD analysis updated", text: "GDP q/q 0.2% vs 0.1% forecast after 0.8% - above the RBNZ's own flat Q2 baseline. NZD holds -1 and no biases flip; second firm kiwi print in three days thins the short case." },
  },
  ...
  snapshot: [
    ...
    {
      icon: "⚠️",
      t: "THE OIL TRIGGER FIRED - WTI 102.138, -3.49%, on the Petroline restart, and USOIL goes from LONG to RANGE",
      s: "This morning's file cut the long from HIGH to MEDIUM precisely because a restart was 84.5% priced by September 30, and the selling arrived the same session: WTI was down 3.7% at 101.92 by 11:32 ET on Energy Secretary Wright's 'measured in days' framing, Brent 105.506 -2.98%. Note the timing - this predates the 18:00Z Fed decision by two hours and is a supply story, not a dollar story. Not flipped SHORT: analysts reading satellite images of the damaged pumping station warn of WEEKS not days, the products bottleneck at roughly 1 million bpd is untouched with diesel at a record 6.23, and the month is still +20.87%."
    },
    {
      icon: "🇯🇵",
    ...
    {
      icon: "🇳🇿",
      t: "NZ Q2 GDP 0.2% q/q vs 0.1% expected - weak in level, but 0.2pp ABOVE the RBNZ's own flat projection",
      s: "The second print in three days to land on the kiwi's firmer side, after confidence rebounded to 89.5 from 80.4. It removes the contraction scenario without giving the RBNZ a reason to move before December 9. NZD holds -1 on the rate-path pillar alone - TE's hold to October 28, six weeks with no hawkish repricing - and no bias flips on 0.1pp, but the short now rests on one pillar rather than two."
    },
    {
      icon: "💵",
      t: "THE FED HIKED to 3.75%-4.00%, actual 4% against a 4% consensus - and DXY 99.836 +0.22% has the month back POSITIVE",
      s: "The first hike since 2023, TE-verified, and roughly 92% priced - so the rate carried no information and the dot plot was always the event. State the limit plainly: the projections and statement text are NOT readable from here yet, the Fed site being blocked and the wires not yet indexed, so no median is quoted and none is invented. The tape leans mildly hawkish - the month flipped from -0.05% to +0.20% and all seven dollar pairs moved together - but gold HELD at +0.74% and silver only faded to +0.82%, which is a firmer dollar rather than a hawkish shock. USD holds +2. Warsh at 18:30Z can still reverse it."
    }
  ],
  ...
  ratePaths: {
    USD: {
      next: "hold",
      when: "DELIVERED - the Fed hiked to a 3.75%-4.00% target range at 18:00Z today, TE confirming actual 4% against a 4% consensus and 3.75% previous. TE's own forecast path now carries 4.00% through this quarter and the next two, with 4.25% not pencilled in until 2027",
      note: "The hike landed exactly as priced: TE confirms actual 4% against a 4% consensus and 3.75% previous, the first Fed hike since 2023, lifting the target range to 3.75%-4.00%. Because it was 92% priced, the rate itself carried no information, and this file said so this morning - the event was always the dot plot. That is where an honest limit has to be stated. The Summary of Economic Projections and the statement text are NOT yet readable from this environment: the Federal Reserve site is blocked here and the newswires have not indexed the release. No dot-plot median is quoted below, because inventing one would be worse than waiting. What IS verifiable is the market's own verdict in the minutes after the release, and it leans mildly hawkish rather than the dovish landmine this file spent two days warning about. DXY is 99.836, +0.22%, having been -0.08% at 06:30Z, and the month has flipped POSITIVE at +0.20% from -0.05% - the single cleanest tell, because the negative month was the explicit warning carried under the dollar longs. Every dollar pair moved the same way: EUR/USD 1.15115 -0.28%, GBP/USD 1.34250 -0.39%, USD/CHF 0.82008 +0.17%, USD/CAD 1.39574 +0.28%, AUD/USD 0.71170 -0.21%, NZD/USD 0.57447 -0.21%, USD/JPY 155.188 +0.06%. Gold held its gain at 4324.25 +0.74% while silver faded from +1.51% to +0.82% - a partial fade, not a reversal, which is what a mildly firmer dollar does rather than a hawkish shock. On the forward path, TE's own model now carries 4.00% through this quarter and the next two with 4.25% not arriving until 2027, which is a HOLD at the next meeting and one further hike well out; futures going into today carried more than that. Whether the dots side with TE or with futures is the question the projections answer, and it is unresolved here. Warsh's press conference at 18:30Z is still to come and is the second live variable. What takes USD to +3: confirmation that the median carries a further 2026 hike with flattened out-years. What takes it to +1: an intact 3.6%/3.4%/3.1% easing path, which would still read dovish against pricing."
    },
    EUR: {
      next: "hold",
    ...
    NZD: {
      next: "hold",
      when: "Oct 28, 01:00Z - TE carries a 2.75% forecast for October with the next move priced for Dec 9 at 3.00%, and tonight's GDP beat firms that December pricing rather than pulling it forward",
      note: "UPDATED POST-RELEASE. Q2 GDP printed +0.2% q/q against a 0.1% consensus and TE house forecast, after +0.8% in Q1 - TE-verified on TE's calendar. The decisive comparison is not the consensus but the RBNZ's own: the September 2 Monetary Policy Statement projected Q2 GDP FLAT at 0.0%, with 0.5% in each of Q3 and Q4, so the economy came in 0.2pp ABOVE the bank's baseline. That matters for the path in a specific and limited way. It removes the downside scenario - a contraction would have let the market start pricing the RBNZ's look-through as a mistake and pushed the next move past December - without creating an upside one, because 0.2% in level is a sharp deceleration to a quarter of Q1's pace and gives no committee a reason to act sooner. So the call is UNCHANGED: hold on October 28, with the next move a hike priced for December 9 at 3.00%, and that December pricing is now marginally better supported than it was before the print. The rest of the TE-verified picture stands: OCR 2.75% after the September 2 hike from 2.50%, CPI 4.1% y/y with +1.5% q/q, unemployment 5.6% and rising from 5.4%, manufacturing PMI 53.1 from 54.3, business confidence 53.7 from 56.1, retail sales -0.5% m/m, balance of trade -1,949m, and consumer confidence at 89.5 from 80.4. The RBNZ's look-through of 4.1% as imported Middle East fuel is intact, with core inflation, wages and expectations still judged consistent with the 1-3% band by mid-2027, and unemployment at 5.6% and rising supports it. The honest summary of the last three days is that the kiwi short has lost its confidence pillar and failed to gain anything from its growth data, leaving the six-week policy vacuum as the whole case. What would change the path: a Q3 CPI showing core rather than fuel behind the 4.1%, which is what would force an October or November re-think. Nothing else this week tests it."
    },
    CAD: {
      next: "hold",
  ...
  today: [
    {
      ccy: "NZD",
      moved: true,
      headline: "Q2 GDP came in at 0.2% q/q against a 0.1% forecast after 0.8% - a sharp deceleration in level, but ABOVE the RBNZ's own flat projection",
      read: "The event yesterday's file named as a bigger risk to NZD/USD than the Fed has passed, and it passed against the short rather than for it: the RBNZ's September Monetary Policy Statement had Q2 GDP FLAT at 0.0%, so 0.2% is 0.2pp above the central bank's own baseline and mildly firms the December 9 hike pricing. Score holds at -1 and nothing flips on 0.1pp, because the level is still a quarter of Q1's pace with unemployment 5.6% and rising, and the rate-path pillar - TE's hold to October 28, six weeks with no hawkish repricing available - is untouched. But this is the second print in three days to land on the kiwi's firmer side after confidence rebounded to 89.5, so the short is now carried on one pillar rather than two: keep it dollar-free through EUR/NZD, AUD/NZD and NZD/CAD, and size it smaller than the board's other spreads."
    },
    {
      ccy: "USD",
      moved: true,
      headline: "THE FED HIKED to 3.75%-4.00% - actual 4% against a 4% consensus, the first hike since 2023 - and the dollar firmed: DXY 99.836, +0.22%, with the month back POSITIVE",
      read: "The rate was 92% priced and told us nothing; the dot plot was always the event, and it is not yet readable here - the Fed site is blocked from this environment and the wires have not indexed it, so no median is quoted and none is invented. What is verifiable is the tape, and it leans mildly hawkish rather than the dovish landmine this file warned about twice: DXY went from -0.08% at 06:30Z to +0.22%, the month flipped from -0.05% to +0.20%, and all seven dollar pairs moved the same way. Gold held +0.74% while silver faded from +1.51% to +0.82% - a partial fade, which is a firmer dollar rather than a hawkish shock. USD holds +2: the stated +3 trigger needs the dots and the stated +1 trigger needs the dots, and neither can be checked yet. Warsh at 18:30Z is the live variable, and the projections remain capable of reversing this within the hour."
    },
    {
      ccy: "JPY",
      moved: true,
  ...
  strength: [
    {
      ...
      tag: "Hiked to 4.00% in line; dots not yet readable",
      drivers: "Policy rate lifted to a 3.75%-4.00% target range at 18:00Z, TE confirming actual 4% against a 4% consensus and 3.75% previous - the first hike since 2023; CPI 3.4% y/y and core 2.4%, unemployment 4.1%, payrolls +162,000, services PMI 56.5, non-manufacturing 55.4; DXY 99.836, +0.22% with the month back positive at +0.20% from -0.05% this morning.",
      forward: "🦅 Tightening, held at +2, and the hike is now delivered: a 3.75%-4.00% target range, TE confirming actual 4% against a 4% consensus and 3.75% previous, the first Fed hike since 2023. Start with what this does NOT tell you. The move was roughly 92% priced, so the rate carried no information, and this file has said for two days that the event was the projections rather than the decision. The projections are not yet verifiable from here - the Federal Reserve site is blocked in this environment and the newswires have not indexed the release - so no dot-plot median appears in this file, and none is guessed. That limit is the single most important thing on this entry, because both of the score triggers written here this morning depend on the dots: +3 required a current-year median at 4.0%-plus with flattened out-years, +1 required an unchanged June profile, and neither can be checked. So the score holds at +2 on evidence rather than on conviction. What IS verifiable is the reaction, and it leans mildly hawkish. DXY is 99.836, +0.22%, against -0.08% at 06:30Z, and the month has flipped positive at +0.20% from -0.05% - which matters more than the daily figure, because a negative month despite 92% hike pricing was the explicit warning this file carried under every dollar long. All seven dollar pairs moved together: EUR/USD 1.15115 -0.28%, GBP/USD 1.34250 -0.39%, USD/CHF 0.82008 +0.17%, USD/CAD 1.39574 +0.28%, AUD/USD 0.71170 -0.21%, NZD/USD 0.57447 -0.21%, USD/JPY 155.188 +0.06%. The metals are the useful cross-check and they argue against over-reading it: gold HELD its gain at 4324.25 +0.74% and silver only faded from +1.51% to +0.82%. A genuinely hawkish dot plot takes gold negative; a partial silver fade with gold intact is a firmer dollar, not a repricing. Note also that one leg of this morning's franc argument has already reversed - USD/CHF was -0.10% at 06:30Z and is now +0.17%. On the path, TE's own model carries 4.00% through this quarter and the next two with 4.25% not arriving until 2027, so TE reads the next meeting as a hold; futures going into today carried more tightening than that, and the dots adjudicate between them. Warsh's press conference at 18:30Z is the second live variable and this entry may need revisiting inside the hour. What takes USD to +3: confirmed projections carrying a further 2026 hike with flattened out-years. What takes it to +1: an intact 3.6%/3.4%/3.1% easing path.",
    },
    {
      ccy: "CAD",
      score: 1,
    ...
    },
    {
      ...
      score: -1,
      verdict: "WEAKENING",
      tag: "GDP beat a low bar; rate pillar intact, case thinner",
      drivers: "Q2 GDP +0.2% q/q against a 0.1% consensus after +0.8% in Q1 - above forecast and above the RBNZ's own FLAT Q2 projection; OCR 2.75% with a hold priced to October 28, CPI 4.1% y/y - the highest in the G10 - unemployment 5.6% and rising from 5.4%, business confidence 53.7 from 56.1, manufacturing PMI 53.1 from 54.3, retail sales -0.5%, trade balance -1,949m, and consumer confidence rebounded to 89.5 from 80.4; NZD/USD 0.57447 into the print, week -1.63%, month -2.67%.",
      forward: "🔻 Easing relative to the board, HELD AT -1 for a second day, and the reason has to be stated precisely because the kiwi has now taken two consecutive data points on its firmer side. Q2 GDP printed +0.2% q/q against a 0.1% consensus. Read it two ways and both are true. In LEVEL it is a sharp deceleration - a quarter of Q1's 0.8% pace, entirely consistent with unemployment at 5.6% and still rising, and it does nothing to challenge the backward-looking WEAKENING verdict. Against EXPECTATIONS it is a beat, and the more important comparison is not the consensus but the RBNZ's own: the September 2 Monetary Policy Statement projected Q2 GDP FLAT at 0.0% before 0.5% in each of Q3 and Q4. The economy came in 0.2pp ABOVE the central bank's forecast, which is the opposite of the contraction a kiwi short wants, and it quietly firms the December 9 pricing rather than threatening it. So the score holds, but on a thinner base than yesterday: the confidence pillar reversed Tuesday at 89.5 from 80.4, and the growth data has now declined to confirm either. What remains is the rate-path pillar alone, and it is untouched and still the largest single fact on this currency - TE carries a hold for October 28, so no hawkish repricing is available to the kiwi for six weeks while the Fed has just hiked to 3.75%-4.00%, the BoE decides in twelve hours and the BoJ on Friday. The RBNZ's look-through of the 4.1% CPI as imported Middle East fuel is intact, with core inflation, wages and expectations still judged consistent with the 1-3% band by mid-2027. What this print does NOT do is give the RBNZ a reason to move sooner, which is why nothing flips on 0.1pp. What would invalidate outright: a Q3 CPI showing core rather than fuel behind the 4.1%, or a third firm print - Q3 employment or a confidence follow-through - which would take this to zero on weight of evidence rather than on any single number."
    }
  ],
  ...
  symbols: [
    {
      ...
      bias: "LONG",
      conv: "MEDIUM",
      why: "Still the cleanest ticket on the board precisely because it carries no dollar leg: a hiking ECB at a 2.50% deposit rate with inflation risks tilted to the upside, against an RBNZ parked to October 28 that has publicly told the market its 4.1% inflation is imported fuel it will look through - and a New Zealand economy that just decelerated to 0.2% q/q from 0.8%.",
      risk: "The short leg keeps getting marginally better news: Q2 GDP beat at 0.2% against 0.1% and landed above the RBNZ's flat projection, after confidence rebounded to 89.5 from 80.4. Held at MEDIUM because the 0.2% level is still a quarter of Q1's pace and the six-week RBNZ vacuum is intact. Both are net energy importers, so a genuine gas and fuel collapse helps the short leg as much as the long one, and a dovish ECB speaker compresses the spread."
    },
    {
      sym: "AUD/NZD",
      bias: "LONG",
      conv: "MEDIUM",
      why: "The other dollar-free way to hold the kiwi short, and the Australian leg improved for the first time in a fortnight: copper turned up 0.57% to 6.4049 and AUD/USD went positive on the month at +0.35%, against an RBNZ signalling a pause to October 28 after Q2 growth slowed to 0.2% q/q, while the RBA still describes inflation as too high with excess demand persistent.",
      risk: "Both legs are conditional and the kiwi leg has now had two firm prints: Q2 GDP at 0.2% beat the 0.1% consensus and came in above the RBNZ's flat projection, after confidence rebounded nine points to 89.5. Australia's August jobs report on September 24 at 01:30Z is still the tripwire that cuts AUD to zero - employment expected +15.1K after -15,827 - and it is the larger of the two risks here."
    },
    {
      sym: "NZD/CAD",
      bias: "SHORT",
      conv: "MEDIUM",
      why: "-1 against +1 with the structural argument intact: a constrained Gulf raises New Zealand's imported fuel bill while improving Canada's terms of trade, and the bottleneck being refined products rather than crude hits a fuel importer harder than it helps a crude exporter. New Zealand's Q2 growth at 0.2% q/q from 0.8% is the kind of deceleration that fuel-import costs produce.",
      risk: "Both legs have softened: the kiwi's Q2 GDP beat at 0.2% against 0.1% landed above the RBNZ's flat projection and follows confidence at 89.5, while Canada's oil tailwind carries an 84.5%-probable Petroline restart by September 30 with WTI already down 3.49% to 102.138. The BoC is frozen at 2.25% by a -0.1% monthly CPI, so the long leg has no rate catalyst of its own."
    },
    {
      sym: "NZD/USD",
      bias: "SHORT",
      conv: "MEDIUM",
      why: "An RBNZ on hold to October 28 against a Fed that has now hiked to 3.75%-4.00% - the rate-path gap is the whole trade and the delivery widened it. Q2 GDP at 0.2% q/q from 0.8% keeps the New Zealand leg soft in level even though it beat a 0.1% consensus.",
      risk: "The named event risk has resolved, but marginally against the ticket: 0.2% was 0.2pp ABOVE the RBNZ's own flat Q2 projection, which firms December pricing and is the second firm kiwi print in three days after confidence at 89.5. Held at MEDIUM rather than cut, because the print gives the RBNZ no reason to move before December and the differential is untouched - but an intact easing path in the still-unverified dots reverses this first and fastest."
    },
    {
      sym: "USD/CHF",
      bias: "LONG",
      conv: "MEDIUM",
      why: "0.82008, +0.17%, week +1.23%, month +1.14%, year-to-date +3.43%. The widest policy gap on the board just got wider in fact rather than in expectation: the Fed is at 3.75%-4.00% against an SNB certain to hold at ZERO on September 24, with Swiss inflation at 0.8% giving no reason to move.",
      risk: "One leg of this morning's downgrade has already reversed - the franc FIRMED at -0.10% at 06:30Z and is now -0.17% weaker against the dollar. That argues the cut from HIGH was premature, but conviction is left at MEDIUM until the projections are actually readable, because the same real-yield mechanism that paused this week is what the dots control. Gold holding +0.74% says the haven bid is not dead."
    },
    {
      sym: "NZD/JPY",
      bias: "SHORT",
      conv: "MEDIUM",
      why: "Still the widest spread available at -1 against +1, with the RBNZ parked for six weeks against a BoJ expected to hike on Friday - Q2 GDP at 0.2% q/q from 0.8% leaves the kiwi leg soft in level even after beating a 0.1% consensus.",
      risk: "Held at MEDIUM after yesterday's cut from HIGH, and both legs are now qualified: the BoJ is reported to hike Friday but offer few clues on terminal, while the kiwi has taken two firm prints in three days - GDP above the RBNZ's flat projection and confidence at 89.5. Friday's 03:00Z BoJ statement is the bigger of the two risks and can widen or close this spread on its own."
    },
    {
      sym: "EUR/USD",
      bias: "SHORT",
      conv: "MEDIUM",
      why: "1.15115, -0.28% on the decision, week -1.05%: the ECB's September 10 hike to a 2.50% deposit rate was fully in the price while the Fed has now DELIVERED to 3.75%-4.00%, and the euro area carries the board's largest energy-import bill with EU gas +33.98% on the month.",
      risk: "This morning's note said the euro had stopped falling at +0.05%; it resumed, which is the cleanest single argument that the release read hawkish rather than dovish. Still the largest position on projections that cannot be verified from here, so it is held rather than added to. An intact easing path in the dots, or a soft Warsh at 18:30Z, reverses it immediately."
    },
    {
      sym: "DXY",
      bias: "LONG",
      conv: "MEDIUM",
      why: "99.836, +0.22% on the hike to 3.75%-4.00%, week +1.03% - and the month has flipped POSITIVE at +0.20% from -0.05% this morning, with EUR at 57.6% of the index weight sitting under a gas bill up 33.98% on the month while the ECB has no meeting until late October.",
      risk: "That monthly sign change removes the specific warning this ticket has carried all week - an index that could not hold a gain despite 92% hike pricing. Conviction stays MEDIUM rather than rising, because the projections that actually decide the dollar are not yet readable here and Warsh speaks at 18:30Z. Confirmed dots carrying a further 2026 hike make this HIGH; an intact easing path sells it."
    },
    {
      sym: "USOIL",
      bias: "RANGE",
      conv: "MEDIUM",
      why: "CHANGED FROM LONG. 102.138, -3.49%, Brent 105.506 -2.98% - and this is the named trigger firing, not a drift. This morning's file cut the long from HIGH to MEDIUM precisely because the Petroline restart was 84.5% priced by September 30, and the selling arrived the same session: WTI was down 3.7% at 101.92 by 11:32 ET on Energy Secretary Wright's 'measured in days' framing. A long whose stated, dated reversal trigger has fired is not a long you keep.",
      risk: "Not flipped SHORT, and deliberately: independent analysts reading satellite images of the damaged pumping station warn the outage could run WEEKS rather than days, the products bottleneck through Hormuz is untouched at roughly 1 million bpd with diesel at a record 6.23 dollars, and the week is still +6.34% with the month +20.87%. Note the timing - this sell-off predates the 18:00Z Fed decision by two hours and is a supply story, not a dollar story. Confirmation the pipeline is actually flowing turns this into a short; a failed restart takes it straight back to LONG."
    },
    {
      sym: "GBP/USD",
      bias: "SHORT",
      conv: "LOW-MED",
      why: "1.34250, -0.39% - the weakest G10 pair on the session. Sterling's hawkish catalyst arrived and delivered nothing (CPI headline 3.1% in line, CORE HELD at 2.6% against 2.7%, a fourth unchanged month with services at 3.4%) and the Fed has now hiked to 3.75%-4.00%. Tomorrow's 6-3 BoE hold is close to locked.",
      risk: "Conviction is left at LOW-MED rather than restored, and the reason is discipline: this was trimmed because the pair ROSE 0.06% on its own CPI, and one post-Fed session does not undo that the sterling leg failed to do any work. The move is dollar-side, not sterling-side. A dovish turn in the unverified projections, or a soft Warsh at 18:30Z, squeezes this hard."
    },
    {
      sym: "JPYBASKET",
      bias: "RANGE",
    ...
    },
    {
      ...
      bias: "RANGE",
      conv: "MEDIUM",
      why: "155.188, +0.06%, weekly +1.07%. Note how LITTLE this moved on a Fed hike - the smallest reaction of any dollar pair - which is the intervention zone doing its work: 155 sits near where officials bought yen ten days ago, with the Takaichi administration openly opposed to further depreciation.",
      risk: "Stays RANGE, and the muted reaction vindicates it. Half the event risk is now spent and the larger half is Friday's BoJ, where Reuters sources point to a hike with few clues on terminal. Hawkish confirmation in the unverified dots plus a BoJ that gives no terminal guidance breaks it higher into intervention territory; an open path to 1.50% breaks it lower just as fast."
    },
    {
      sym: "XAU/USD",
      bias: "RANGE",
      conv: "MEDIUM",
      why: "4324.25, +0.74% - gold HELD essentially all of its gain through the Fed hike, which is the single most useful cross-check on the board right now. A genuinely hawkish set of projections takes gold negative; it did not. Yesterday's switch from SHORT to RANGE came on falling US real yields and that call survives the event.",
      risk: "Stays RANGE rather than turning long: the week is still -1.68% and the month -2.08%, managed money is crowded long roughly 228,000 net contracts, and the projections that decide the real-yield path are not yet readable here. Warsh at 18:30Z can still resume the downtrend, and a confirmed hawkish median with flattened out-years does it fastest."
    },
    {
      sym: "XAG/USD",
      bias: "RANGE",
      conv: "LOW-MED",
      why: "64.170, +0.82% - silver gave back roughly half its session gain on the hike, having been +1.51% at 06:30Z, while gold held. That relative fade is exactly what the higher-beta metal does against a firmer dollar, and it is a partial fade rather than a reversal, so yesterday's switch from SHORT to RANGE stands. The industrial leg firmed: copper +0.94%.",
      risk: "The weakest of the three metal legs and the lowest conviction on the board: silver is -4.61% on the week against gold's -1.68%. It remains the highest-beta instrument here in both directions, and with the projections unreadable and Warsh at 18:30Z still to come, that beta is a reason to size down rather than to pick a side."
    },
    {
      sym: "EUR/CHF",
      bias: "LONG",
    ...
    },
    {
      ...
      bias: "SHORT",
      conv: "LOW-MED",
      why: "The board's weakest currency against a haven with a 0% rate, and the RBNZ's six-week policy vacuum is the edge - the entire case comes from the kiwi leg rather than from the franc, with Q2 growth down to 0.2% q/q from 0.8%.",
      risk: "Kept at LOW-MED because everything that has moved recently moved against it: the kiwi's GDP beat 0.1% and printed above the RBNZ's own flat forecast, confidence rebounded to 89.5, and the franc firmed as gold rose 0.79% with the 10-year easing from 5.04%. A short-versus-short pairing where both shorts are improving is one to hold small or leave alone."
    },
    {
      sym: "USD/CAD",
      bias: "LONG",
      conv: "MEDIUM",
      why: "RAISED FROM LOW-MED. 1.39574, +0.28%, week +1.10%. The Fed delivered its hike to 3.75%-4.00% against a Bank of Canada frozen at 2.25% by a -0.1% monthly CPI print, 41,700 August job losses and retail sales at -0.8%, so the rate gap is now realised rather than priced.",
      risk: "The upgrade is earned by the other leg rather than the dollar: this ticket was held at LOW-MED expressly because WTI kept adding and the loonie's terms-of-trade tailwind was outperforming its central bank. WTI is now 102.138, -3.49%, on the Petroline restart - that offset has gone. The caveat is that CAD's own score is not reassessed here, only the dollar side; a failed pipeline restart restores the tailwind, and Warsh at 18:30Z still governs the dollar leg."
    },
    {
      sym: "EUR/CAD",
      bias: "SHORT",
    ...
    },
    {
      ...
      bias: "LONG",
      conv: "LOW-MED",
      why: "Zero against -1 with the RBNZ parked to October 28 and no hawkish repricing available to the kiwi for six weeks after Q2 growth slowed to 0.2% q/q, while sterling at least has a decision in twelve hours.",
      risk: "A kiwi short with a deteriorating funding leg and a firming target: UK core CPI held at 2.6% against 2.7% expected, a fourth unchanged month with services steady at 3.4%, which shuts sterling's route to +1 and leaves the 11:00Z BoE vote able only to take GBP to -1. Meanwhile the kiwi beat on GDP and on confidence. The weakest of the seven kiwi expressions and the one to skip."
    },
    {
      sym: "EUR/GBP",
      bias: "LONG",
    ...
    },
    {
      ...
      bias: "RANGE",
      conv: "LOW-MED",
      why: "6.4285, +0.94% - a third consecutive session without a decline, and the gain EXTENDED through a Fed hike, which a purely dollar-driven metal does not do. China's industrial production beat at 5.2% against a 4.8% consensus remains the driver, that being the production half copper is physically consumed by.",
      risk: "Still -5.51% on the week and -2.66% on the month, so this is stabilisation rather than a turn, and China's retail sales missed at 0.4%. Copper firming is the one clean support left under AUD after the Fed delivered. A weak Australian jobs print on September 24 or another China demand miss resumes the downtrend."
    },
    {
      sym: "GER40",
      bias: "SHORT",
    ...
    },
    {
      ...
      bias: "SHORT",
      conv: "LOW-MED",
      why: "0.71170, -0.21%, week -1.39%, an RBA sitting out to September 29 against a Fed that has now hiked to 3.75%-4.00%. The domestic picture is still softening, with unemployment up to 4.5% and employment at -15,827.",
      risk: "Conviction stays LOW-MED and the reason is unchanged: the pair is STILL positive on the month at +0.17% and +6.66% year-to-date, so this remains the unwind of a large gain rather than a breakdown. Copper extending to +0.94% through the hike is a real offset working against this ticket. The September 24 jobs report is the tripwire; dovish projections squeeze it hard."
    },
    {
      sym: "EUR/JPY",
      bias: "RANGE",
  ...
  catalysts: [
    ...
    },
    {
      ...
      impact: "high",
      note: "RELEASED. The Fed raised the target range to 3.75%-4.00% - actual 4% against a 4% consensus and 3.75% previous, TE-verified, the first hike since 2023. The rate was roughly 92% priced and therefore carried no information; the event was always the projections. IMPORTANT LIMIT: the Summary of Economic Projections and the statement text are NOT yet verifiable from this environment - the Federal Reserve site is blocked here and the newswires have not indexed the release - so no dot-plot median is quoted and none is guessed. The market's own read in the minutes after leans mildly hawkish rather than dovish: DXY 99.836 +0.22% against -0.08% at 06:30Z, with the month flipping positive at +0.20%, and all seven dollar pairs moving together. Gold holding +0.74% and silver fading only to +0.82% argues against reading it as a hawkish shock. Warsh's press conference at 18:30Z is the live variable and the dots may yet reverse this. USD holds +2.",
      when: "2026-09-16T18:00:00Z",
      result: [
        { title: "Federal Funds Rate", actual: "4.00%", forecast: "4.00%", previous: "3.75%", cmp: "= in line" }
      ]
    },
    {
      date: "Sep 16",
    ...
    {
      date: "Sep 16",
      event: "New Zealand GDP (Q2, June quarter)",
      impact: "high",
      note: "RELEASED, and this was the event yesterday's file named as a bigger risk to NZD/USD than the Fed. Q2 GDP q/q came in at 0.2% against a 0.1% consensus, after 0.8% in Q1 - above forecast, TE-verified on TE's own calendar, which also carried 0.1% as its house forecast. Two readings, both true and pointing in different directions. In LEVEL it is a sharp deceleration - growth ran at a quarter of Q1's pace and is consistent with unemployment at 5.6% and still rising. Against EXPECTATIONS it is a beat, and more importantly it is above the RBNZ's OWN baseline: the September 2 Monetary Policy Statement projected Q2 GDP FLAT at 0.0% before 0.5% in each of Q3 and Q4. A print 0.2pp above the central bank's own forecast does not hand the doves a contraction to trade, and it does not give the RBNZ a reason to pull its next move forward either. The marginal effect is to firm the December 9 hike pricing slightly and remove a downside tail from the kiwi, rather than to create an upside catalyst. NZD holds at -1 and no bias flips on 0.1pp, but this is the SECOND consecutive print to land on the firmer side of the kiwi short after Westpac consumer confidence rebounded to 89.5 from 80.4, and the short case is now thinner than it was 48 hours ago.",
      when: "2026-09-16T22:45:00Z",
      result: [
        { title: "GDP q/q", actual: "0.2%", forecast: "0.1%", previous: "0.8%", cmp: "▲ above" }
      ]
    },
    {
      date: "Sep 17",
  ...
  macro: {
    ...
    NZD: {
      ...
      growth: { value: "1.5%", trend: "falling", note: "Q1 y/y; Q2 +0.2% q/q", hist: [-0.5, -0.7, 0.3, 1.3, 1.5, 1.5] },
